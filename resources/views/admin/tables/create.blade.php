    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-end m-2 p-2">
                <a href="{{ route('admin.tables.index') }}" class="px-4 py-2 bg-white rounded-lg">Back to Table</a>
            </div>
                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{ route('admin.tables.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="sm:col-span-6 pt-6">
                            <label for="guest_number" class="block text-sm font-medium text-white"> Guest Number </label>
                            <div class="mt-1">
